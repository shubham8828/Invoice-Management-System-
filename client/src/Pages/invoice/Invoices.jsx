...
const Invoices = () => {
  ...
  useEffect(() => {
    const fetchInvoices = async () => {
      try {
        ...
        const response = await axios.post('https://invoice-management-system-server.vercel.app/invoice/get', { email });
  ...
  const deleteInvoice = async (id) => {
    try {
      await axios.delete(`https://invoice-management-system-server.vercel.app/invoice/delete/${id}`)
      .then((res)=>{
